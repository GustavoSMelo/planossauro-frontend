...
<template>
    <nav class="navContainer">
        ...
        <span>
            ...
            <button v-else type="button" class="btnIcon" @click="toggle(false)">
    ...
    <main class="mainContent">
        ...
        <div class="mainWrapper">
            ...
            <section class="humansForHumansContainer">
                <h2
                    class="categoryTitle"
                    :data-theme="isDark ? 'dark' : 'light'"
                >
